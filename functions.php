...
function html5blank_header_scripts() {
    if ( $GLOBALS['pagenow'] != 'wp-login.php' && ! is_admin() ) {
        if ( HTML5_DEBUG ) {
            ...
            // Slick
            wp_register_script( 'slick', get_template_directory_uri() . '/js/lib/slick.min.js', array(), '1.0.0' );

            // Slick
            wp_register_script( 'flickity', get_template_directory_uri() . '/js/lib/flickity.pkgd.min.js', array(), '2.2.1' );
...
function html5blank_styles() {
    if ( HTML5_DEBUG ) {
        ...
        // Custom CSS
        wp_register_style( 'html5blank', get_template_directory_uri() . '/style.css', array( 'slick' ), '1.0' );
